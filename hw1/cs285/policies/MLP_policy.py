...
class MLPPolicy(BasePolicy):
    ...
    def get_action(self, obs):
        ...
        # ?? what are other indexes of session.run
...
class MLPPolicySL(MLPPolicy):
    ...
    def update(self, observations, actions):
        ...
        _,loss = self.sess.run(self.train_op, feed_dict={self.observations_pl: observations, self.acs_labels_na: actions})
        # ?? what is the value of _
