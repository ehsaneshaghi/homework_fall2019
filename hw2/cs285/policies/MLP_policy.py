...
class MLPPolicyPG(MLPPolicy):
    ...
    def define_train_op(self):
        ...
        self.loss = tf.reduce_sum(-self.logprob_n*self.adv_n) #TODO
        ...
        if self.nn_baseline:
            ...
            self.baseline_loss = tf.losses.mean_squared_error(self.baseline_prediction,self.targets_n)#TODO
    ...
    def update(self, observations, acs_na, adv_n=None, acs_labels_na=None, qvals=None):
        ...
        if self.nn_baseline:
            ...
            _,baseline_loss = self.sess.run([self.baseline_update_op],feed_dict={self.targets_n:targets_n,self.observations_pl:observations})
        return loss
